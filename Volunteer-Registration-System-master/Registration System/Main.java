...
public class Main{
        ...
        do{
            ...
            if(resp1 == 1){// Option for student 
                ...
                do{
                    ...
                    LinkedList volunteerList = getVolunteerList();
    ...
    static void displayHighest(LinkedList list){ // Display volunteer with highest volunteering hour and allowance
        Node current = list.head;
        Node last = list.last;
    ...
    static Queue readStudent(){ // Fetch student data from io file to queue
    ...
    static int HomeScreen(Scanner in){ // Home screen for program
        clearScreen();
    ...
    static int adminScreen(Scanner in){ // Option screen for admin
    ...
    static int volunteerScreen(Scanner in){ // Option screen for volunteer
    ...
    static Volunteer volunteerRegister(Scanner in){ // Screen for volunteer registration
    ...
    static int studentScreen(Scanner in){ // Option screen for student
        //Scanner in = new Scanner(System.in);
    ...
    static Student studentRegister(Scanner in){ // Screen for student registration
        //Scanner in = new Scanner(System.in);
    ...
    static void writeVolunteerRegistration(Volunteer data){ // write volunteer data on io file
    ...
    static void writeStudentRegistration(Student data){ // Write student data on io file
